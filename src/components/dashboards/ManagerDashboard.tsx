...
export function ManagerDashboard() {
  ...
  const { tasks: rawTasks, employees, pendingApprovals, loading, refetch } = useManagerData();
    ...
    <View style={styles.container}>
      {pendingApprovals > 0 && (
        ...
        >
          ...
          <Text style={styles.alertText}>Action Required: {pendingApprovals} Pending Employee Registrations</Text>
