-- Migration: 20260825000020_task_segregation_system.sql
-- Description: Implements atomic task segregation / decomposition RPC with hierarchical alerts, audit logging, and RLS enforcement
...
BEGIN
    ...
    LOOP
        ...
        IF v_assignee_id IS NOT NULL THEN
            ...
            -- Department isolation validation (unless Founder or cross-dept manager)
    ...
    -- 6. Build summary for original assigner notification
