-- Migration: 20260826000021_founder_oversight_segregation.sql
-- Description: Ensure all Founders receive an oversight notification whenever ANY task is segregated, across all levels of hierarchy (Dept Head, Manager, Employee)
